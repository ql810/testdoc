...
global_substitutions = 'global_substitutions.txt'

# Load the contents of the global substitutions file into the 'rst_prolog' variable.
# This ensures that the substitutions are all inserted into each page.
with open(global_substitutions, 'r') as subs:
